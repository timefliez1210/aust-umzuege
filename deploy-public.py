#!/usr/bin/env python3
"""Deploy public site only: everything except admin.html and its compressed variants."""
...
def count_files(local_dir):
    ...
    for entry in os.listdir(local_dir):
        ...
        elif os.path.splitext(entry)[1] not in SKIP_EXT and entry not in SKIP_FILES:
            total += 1
    return total
...
print(f"Uploading {total_files} files (skipping admin.html)...")
