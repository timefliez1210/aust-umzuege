...
<main class="datenschutz">
    <div class="datenschutz__container">
        <h1 class="datenschutz__heading">Datenschutzerklärung</h1>

        <!-- 1. Datenschutz auf einen Blick -->
        <section class="datenschutz__section">
        ...
        <section class="datenschutz__section">
            ...
            <p>
                ...
                verwaltungsrechtlicher oder gerichtlicher Rechtsbehelfe. Eine
                Liste der Datenschutzbeauftragten sowie deren Kontaktdaten
                können folgendem Link entnommen werden: <a
                    href="https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html"
                    target="_blank"
                    rel="noopener noreferrer">https://www.bfdi.bund.de</a
                >
                (Deutschland) und
                <a
                    href="https://www.dsb.gv.at/kontakt"
                    target="_blank"
                    rel="noopener noreferrer">https://www.dsb.gv.at/kontakt</a
                > (Österreich).
            </p>
            ...
            <p>
                ...
                Zahlungsabwicklung benötigt. Der Zahlungsverkehr über die
                gängigen Zahlungsmittel (Visa/MasterCard, Lastschriftverfahren)
                erfolgt ausschließlich über eine verschlüsselte SSL- bzw.
                TLS-Verbindung. Eine verschlüsselte Verbindung erkennen Sie
                daran, dass die Adresszeile des Browsers von „http://" auf
                „https://" wechselt und an dem Schloss-Symbol in Ihrer
                Browserzeile. Bei verschlüsselter Kommunikation können Ihre
                Zahlungsdaten, die Sie an uns übermitteln, nicht von Dritten
                mitgelesen werden.
            </p>
        ...
        <section class="datenschutz__section">
            ...
            <p>
                ...
                Widerruf unberührt. Die von Ihnen im Kontaktformular
        ...
        <section class="datenschutz__section">
            ...
            <p>
                ...
                durch Anklicken des Instagram-Buttons die Inhalte unserer Seiten
                ...
                Instagram erhalten. Die Verwendung des Instagram-Plugins erfolgt
            ...
            <p>
                ...
                Datenschutzerklärung von Instagram: <a
        ...
        <section class="datenschutz__section">
            ...
            <p>
                ...
                Netzwerken. Soziale Netzwerke wie Facebook, Instagram etc.
                können Ihr Nutzerverhalten in der Regel umfassend analysieren,
                wenn Sie deren Webseite oder eine Webseite mit integrierten
                Social-Media-Inhalten (z. B. Like-Buttons oder Werbebannern)
                besuchen.
            </p>
            <p>
                ...
                Ihre personenbezogenen Daten können unter Umständen aber auch
                dann erfasst werden, wenn Sie nicht eingeloggt sind oder keinen
                Account beim jeweiligen Social-Media-Portal besitzen.
            </p>

            <h3>Rechtsgrundlage</h3>
            <p>
                Unsere Social-Media-Auftritte sollen eine möglichst umfassende
                Präsenz im Internet gewährleisten. Hierbei handelt es sich um
            ...
            <p>
                ...
                Details entnehmen Sie der Datenschutzerklärung von Facebook: <a
...
<style>
    ...
    .datenschutz__section li {
        margin-bottom: var(--space-2);
    }

    .datenschutz__section a {
        color: var(--color-nav-accent);
        text-decoration: none;
        transition: color var(--transition-fast);
    }

    .datenschutz__section a:hover {
        color: #d84a00;
