...
<main class="guide-detail">
	<div class="guide-detail__container">
		...
		<article class="guide-article">
			...
			<div class="guide-cta">
				<h2>Auf der Suche nach einem zuverlässigen Partner?</h2>
				<p>
					Transparenz, Festpreisgarantie nach Besichtigung und umfassende
					Versicherung – bei uns Standard.
				</p>
				<a href="/kostenloses-angebot" class="cta-button"
					>Unverbindliches Angebot anfragen</a
				>
			</div>
		</article>
	</div>
